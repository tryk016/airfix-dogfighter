...
| `ExportIndirectCallsByDisplacement.java` | locate indirect calls containing one or more exact recovered vtable displacements and decompile their owning functions |
