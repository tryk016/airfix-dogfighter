...
- The new Ghidra reference exporter compiled and ran headlessly. Forty-three
  selected Ghidra reports contain no unresolved-address marker, and all 19
  normalized Rizin boundaries match the public ledger. The three RE wrapper
  suites, 12 Rizin tests, synthetic public-boundary tests and 548-file scan,
  276-row/14-column unique function catalog, changed-document links,
