...
| Camera | P0 | observed | SCN-CAMERA-001 | Exact world-to-camera point, positive-Z projection/depth, four depth states, gameplay presets, vehicle quaternion matrix, stateless chase, collision/factor primitives, retained BSP line/portal queries, runtime/source-world basis adaptation, static sphere correction, atomic position/room/factor proposals, immutable SPSC frame publication, look-at math, and parity-first 640x480 aspect-fit implemented; dynamic-object collision, complete pose assembly, controlled runtime traces, and Metal integration remain |
