...
| Camera | P0 | observed | SCN-CAMERA-001 | Exact world-to-camera point, positive-Z projection/depth, four depth states, gameplay presets, vehicle quaternion matrix, stateless chase, collision/factor/line primitives, look-at math, and parity-first 640x480 aspect-fit implemented; BSP/portal queries, stateful camera publication, dynamic pose, and Metal integration remain |
