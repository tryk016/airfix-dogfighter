...
| Camera | P0 | observed | SCN-CAMERA-001 | Exact world-to-camera point, positive-Z screen projection with reciprocal depth, and parity-first 640x480 aspect-fit layout implemented; fixed 520x310 gameplay window, object relation, clipping, room/portal traversal, and Direct3D staging recovered; gameplay camera pose/modes and clear-depth call remain unknown |
