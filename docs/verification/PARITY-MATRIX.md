...
| Camera | P0 | observed | SCN-CAMERA-001 | Exact world-to-camera point, positive-Z projection/depth, four depth states, gameplay presets, vehicle quaternion matrix, chase, AirCraft factor recovery with its scheduler delta confirmed in seconds, collision/factor primitives, retained BSP line/portal queries, runtime/source-world basis adaptation, static sphere plus line correction, atomic position/room/factor completion, immutable SPSC frame publication, unit-scale look-at pose snapshot, ordered world projection, transactional producer-side step composition, homogeneous Metal packet, bounded complete-packet exchange and render lease, reverse-depth gameplay pipeline, tested camera0 bootstrap, and parity-first 640x480 viewport implemented; simulation producer endpoint, dynamic-object and transparent collision-portal paths, controlled runtime traces, and device acceptance remain |
