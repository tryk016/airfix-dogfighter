...
| Camera | P0 | observed | SCN-CAMERA-001 | Exact world-to-camera point and positive-Z scalar screen projection implemented; object relation, engine near/far/FOV, clipping order, room/portal traversal, and Direct3D staging recovered; gameplay camera modes, Metal depth, and widescreen policy remain unknown |
