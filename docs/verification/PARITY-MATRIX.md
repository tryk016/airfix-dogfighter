...
| Camera | P0 | observed | SCN-CAMERA-001 | Exact world-to-camera point, positive-Z projection/depth, four depth states, gameplay preset selection, vehicle quaternion matrix, stateless chase target/smoothing, and parity-first 640x480 aspect-fit implemented; full-screen setup, zero clear, clipping, portals, collision correction, factor recovery, look-at, and D3D staging recovered; dynamic pose and Metal integration remain |
