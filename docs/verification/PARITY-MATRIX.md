...
| Camera | P0 | observed | SCN-CAMERA-001 | Exact world-to-camera point, positive-Z projection/depth, four depth states, gameplay preset selection, stateless chase target/smoothing, and parity-first 640x480 aspect-fit implemented; full-screen setup, zero clear, clipping, portals, collision correction, look-at, and D3D staging recovered; quaternion adapter, dynamic pose, and Metal integration remain |
