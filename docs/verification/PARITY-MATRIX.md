...
| Camera | P0 | observed | SCN-CAMERA-001 | Exact positive-Z scalar screen projection implemented; engine near/far/FOV, far/near clipping order, room render list, depth-bounded portal recursion, movement-time portal-BSP traversal, and Direct3D triangle staging recovered; world-to-view, gameplay camera modes, Metal depth, and widescreen policy remain unknown |
