...
| Camera | P0 | observed | SCN-CAMERA-001 | Exact world-to-camera point, positive-Z projection/depth, four depth states, gameplay presets, vehicle quaternion matrix, stateless chase, collision/factor primitives, retained BSP line/portal queries, look-at math, and parity-first 640x480 aspect-fit implemented; sphere resolution, runtime-basis/stateful camera publication, dynamic pose, and Metal integration remain |
